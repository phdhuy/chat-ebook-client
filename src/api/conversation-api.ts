...
export const conversationApi = {
  ...
  deleteConversation: async (
    ...
    const response = await api.delete(`/v1/conversations/${conversationId}`);
    return response.data;
  },
  ...
  updateConversation: async (
    ...
    const response = await api.put(`/v1/conversations/${conversationId}`, body);
    return response.data;
  },
